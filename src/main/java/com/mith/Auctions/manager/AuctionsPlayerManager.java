...
import com.mith.Auctions.gson.AuctionsPlayerSerializer;
import com.mith.Auctions.object.AuctionsPlayer;
import com.mith.Auctions.object.AuctionsPlayerList;
...
public class AuctionsPlayerManager {
    ...
    private final File FILE = new File("plugins/Auctions", "players.json");
    ...
    private void loadGson() {
        ...
        try {
            ...
            if (!(ex instanceof NoSuchElementException)) {
                Bukkit.getLogger().log(Level.SEVERE, "[Auctions] Error loading players!", ex);
            }
