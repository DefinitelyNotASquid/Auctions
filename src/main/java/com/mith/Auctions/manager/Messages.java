...
public class Messages {
    ...
    private final File FILE = new File("plugins/Auctions", "messages.properties");
    ...
    private String getStringFromBundle(String key, Object... args) {
        try {
            ...
            Bukkit.getLogger().severe("[Auctions] Missing message in message.properties! Message key: " + key);
            return key;
        }
    }
